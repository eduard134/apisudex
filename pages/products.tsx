        ...
        <div className="flex flex-wrap justify-center mt-10 gap-8">
          {filteredProducts.map((product: Product) => (
            <Link
              ...
              key={product.id}
              className="mb-6 md:mb-0 md:mr-[5vw] flex flex-col justify-center items-center rounded-md p-2 md:p-5 h-[full] md:w-[15%] bg-slate-100 border hover:border-black"
            >
